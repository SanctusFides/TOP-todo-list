...
function retrieveStorage() {
  ...
  if (localStorage.getItem("storedManager")) {
    ...
    localStorage.setItem(
      "storedManager",
      JSON.stringify(managerObj.projectList)
    );
    generalCreation();
  }
}
...
function addToDo(id) {
  ...
  saveEditBtn.className = "save-button";
  saveEditBtn.addEventListener("click", function () {
    saveNewToDo(id, nameField.value, priorityField.value, notesField.value);
  });
  todoContent.appendChild(saveEditBtn);
}
...
function addProject() {
  ...
  saveEditBtn.className = "save-button";
  saveEditBtn.addEventListener("click", function () {
    saveNewProject(nameField.value, descriptionText.value);
  });
